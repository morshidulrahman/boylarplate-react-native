        ...
        <Tab.Navigator
            ...
            <Tab.Screen name="HomeScreen" component={HomeScreen}
                options={{
                    tabBarLabel: 'Home',
                    tabBarIcon: ({ focused }) => (
                        <Ionicons name="home" size={22} color={focused ? "#0081C9" : "gray"} />
                    ),
                }}
            />
            ...
            <Tab.Screen name="SendMoneyScreen" component={SendMoneyScreen}
                options={{
                    tabBarLabel: 'SendMoneyScreen',
                    tabBarIcon: ({ focused }) => (
                        <FontAwesome name="send" size={22} color={focused ? "#0081C9" : "gray"} />
                    ),
                }}
            />
            <Tab.Screen name="profile" component={ProfileScreen}
                options={{
                    tabBarLabel: 'profile',
                    tabBarIcon: ({ focused }) => (
                        <FontAwesome5 name="user-alt" size={22} color={focused ? "#0081C9" : "gray"} />
                    ),
                }}
            />
        </Tab.Navigator>
