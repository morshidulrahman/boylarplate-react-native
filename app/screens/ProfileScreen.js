    ...
    <SafeAreaWrapper style={tw`bg-white flex-1 pt-5`}>
      <View style={tw`p-4 w-full bg-white  justify-center items-center`}>
        ...
        <View style={tw`items-center justify-center mt-8`}>
          <Text style={tw`text-3xl font-semibold text-[#000000] mb-1`}>
            Roxini Rathor
          </Text>
          <Text style={tw`text-sm  text-[#808080]`}>
            rathorcomplex@gamil.com
          </Text>
        </View>
      </View>
      <View style={tw`mt-5 p-10`}>
        <View style={tw`flex-row items-center mb-8 w-full`}>
          <Text
            style={tw`flex items-center justify-center bg-[#F7F6F2] p-2 rounded-full mr-6`}
          >
            <FontAwesome5 name="key" size={22} color={"green"} />
          </Text>
        ...
        <View style={tw`flex-row items-center mb-8 w-full`}>
          <Text
            style={tw`flex items-center justify-center bg-[#F7F6F2] p-2 rounded-full mr-6`}
          >
            <FontAwesome5 name="language" size={22} color={"green"} />
          </Text>
        ...
        <View style={tw`flex-row items-center mb-8 w-full`}>
          <Text
            style={tw`flex items-center justify-center bg-[#F7F6F2] p-2 rounded-full mr-6`}
          >
            <FontAwesome5 name="headphones-alt" size={22} color={"green"} />
          </Text>
